...
static const char *tag = "SBC2302_A"; // Device name(as seen by connected devices)
...
static unsigned char *buffer_1;
static unsigned char *buffer_2;
...
void set_dir(unsigned char *_buffer_1, unsigned char *_buffer_2)
{
    buffer_1 = _buffer_1;
    buffer_2 = _buffer_2;
}